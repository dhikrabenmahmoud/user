...
class QuizzController extends AbstractController
{
     ...
     */
    public function getQuizz(Request $request, Question $question, $id, QuizzHistoryRepository $quizzHistoryRepository): Response
    {
        $score = 0;
        $numberOfQuestions = 0;
        ...
        if (!empty($post)) {
            ...
            if (!empty($currentUser)) {
                ...
                $entityManager->flush();
                $higher = $quizzHistoryRepository->findHigher($score);

                //////////////
            
        
               if($score >= $higher[0]->getScore()){
                    ...
                    $content = $this->renderView('quizz/download.html.twig', [
                    ...
                    $DomPdf->render();
                    $fileName = $currentUser->getUsername()."Score".$score.'.pdf';
